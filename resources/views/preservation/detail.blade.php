    ...
    <div class="p-5">
        <div
            ...
            <div>
                ...
                @php
                $bread = [
                ['url' => '/preservation', 'label' => 'Preservations'],
                ['url' => '/preservation/'.$slope->slug, 'label' => $slope->slope_name,'active' => true],
            ...
            <div class="col-span-2 ">
                <div class="p-3 sm:p-5 mb-5 bg-white border border-gray-200 shadow-sm rounded-2xl">
                    ...
                    <div class="my-2 flex justify-end">
                        <x-primary-link href="/create/preservation/{{$slope->slug}}">
                            Add Slope Preservation
                        </x-primary-link>
                    </div>
                    <div>
                        <div>
                            ...
                            <a href="/preservation/{{$preservation->slug}}/{{$preservation->id}}">
                                <div
                                    ...
                                    <div class="w-full border-r border-gray-300">
                                        <div class="text-lg font-bold">Preservation on:</div>
