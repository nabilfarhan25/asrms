<div class="grid sm:grid-cols-2 gap-4">
    ...
    <div>
        <div x-data="{ surface_opt: 'Vegetation', coverPercentage: '' }" class="mb-3">
            ...
            <div class="flex items-center mb-2">
                <input type="radio" value="Chunam" x-model="surface_opt" id="surface_cover2" name="surface_cover"
                    class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="surface_cover2" class="ms-2 text-sm text-gray-900 dark:text-gray-300">
                    Chunam
                    <input type="number" step="0.01" x-show="surface_opt === 'Chunam'" x-model="coverPercentage"
                        placeholder="%" required
                        class=" p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-lime-500 focus:border-lime-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-lime-500 dark:focus:border-lime-500">
                </label>
            </div>
            ...
            <div class="flex items-center mb-2">
                <input type="radio" value="Concrete" x-model="surface_opt" id="surface_cover3" name="surface_cover"
                    class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="surface_cover3" class="ms-2 text-sm text-gray-900 dark:text-gray-300">Concrete
                    <input type="number" step="0.01" x-show="surface_opt === 'Concrete'" x-model="coverPercentage"
                        placeholder="%" required
                        class=" p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-lime-500 focus:border-lime-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-lime-500 dark:focus:border-lime-500">
                    <span class="ml-1">(including shotcrete or other hard material)</span></label>
            </div>

            <div class="flex items-center mb-2">
                <input type="radio" value="Bare surface" x-model="surface_opt" id="surface_cover4" name="surface_cover"
                    class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="surface_cover4" class="ms-2 text-sm text-gray-900 dark:text-gray-300">
                    Bare surface
            ...
            <div class="flex items-center mb-2">
                <input type="radio" value="Others" x-model="surface_opt" id="surface_cover5" name="surface_cover"
                    required
                    class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="surface_cover5" class="ms-2 text-sm text-gray-900 dark:text-gray-300">Others</label>
            </div>
    ...
    <div
        ...
        <div class="mb-3">
            ...
            <div class="flex flex-col space-y-2 mb-2">
                ...
                <label class="flex items-center text-sm">
                    <input type="radio" name="water_carrying_services" value="None of the above "
...
<div class="grid sm:grid-cols-2 gap-4">
    <div>
        <h4 class="font-bold">Catchment Characteristics
        </h4>
    </div>
    <div>
        <div class="mb-3">
            <legend class=" font-semibold mb-2">Provide the following data based on SIFT Report on the slope:
                Size of Catchment :</legend>
            <input type="text" placeholder="m2" name="size_of_catchment" required
            ...
            <legend class=" font-semibold mb-2">Topographic Setting:</legend>
            <div class="flex flex-col space-y-2 mb-2">
                <label class="flex items-center text-sm">
                    <input type="radio" name="catchment_characteristics" value="Traverse drainage line" checked
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    Traverse drainage line
                </label>
                <label class="flex items-center text-sm">
                    <input type="radio" name="catchment_characteristics" value="Adjacent to drainage line"
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    Adjacent to drainage line
                </label>
                <label class="flex items-center text-sm">
                    <input type="radio" name="catchment_characteristics" value="Traverse topographic depression"
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    Traverse topographic depression
                </label>
                <label class="flex items-center text-sm">
                    <input type="radio" name="catchment_characteristics" value="Adjacent to topographic depression"
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    Adjacent to topographic depression
                </label>

                <label class="flex items-center text-sm">
                    <input type="radio" name="catchment_characteristics" value="Planar slope"
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    Planar slope
                </label>
                <label class="flex items-center text-sm">
                    <input type="radio" name="catchment_characteristics" value="Spur"
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    Spur
                </label>
            </div>
...
<div class="grid sm:grid-cols-2 gap-4">
    <div>
        <h4 class="font-bold">Volume of Fill Body
        </h4>
    </div>
    <div>
        <div class="mb-3">

            <legend class=" font-semibold mb-2">Volume of fill body estimated by :</legend>
            <div class="flex flex-col space-y-2 mb-2">
                <label class="flex items-center text-sm">
                    <input type="radio" name="volume_fill_estimate_by" value="SIFT Report" checked
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    SIFT Report
                </label>
                <label class="flex items-center text-sm">
                    <input type="radio" name="volume_fill_estimate_by" value="Field measurement"
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    Field measurement (if SIFT data are not available)
                </label>
                <label class="flex items-center text-sm">
                    <input type="radio" name="volume_fill_estimate_by" value="API"
                        class="w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 mr-2">
                    API
                </label>
            </div>

            <legend class=" font-semibold mb-2">Estimated volume of fill body :</legend>
            <input type="text" placeholder="m3" name="volume_fill_estimate" required
                class="w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-xs focus:ring-lime-500 focus:border-lime-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-lime-500 dark:focus:border-lime-500">
        </div>
...
<div class="grid sm:grid-cols-2 gap-4">
    <div>
        <h4 class="font-bold">Channelisation of Debris
        </h4>
    </div>
    <div>
        <div class="mb-3">
            <legend class="font-semibold mb-2">Provide data based on SIFT Report on the slope: <br>
                In case of failure, channelization of debris flow is possible:</legend>
            <div class="mb-2">
                <div class="mr-4">
                    <input id="channelisation_of_debris1" type="radio" value="Yes" name="channelisation_of_debris"
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="channelisation_of_debris1"
                        class="ms-2 text-sm text-gray-900 dark:text-gray-300">Yes</label>
                </div>
                <div class="mr-4">
                    <input id="channelisation_of_debris2" type="radio" value="No" name="channelisation_of_debris"
                        checked
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="channelisation_of_debris2" class="ms-2 text-sm text-gray-900 dark:text-gray-300">No
                    </label>
                </div>
                <p class="text-sm my-2">
                    If the required data are not available in SIFT report, then No should be assumed.
                </p>
            </div>
        </div>
...
<div class="grid sm:grid-cols-2 gap-4">
    ...
    <div>
        <div class="mb-3">
            ...
            <div class="mb-2">
                <div class="mr-4">
                    <input id="erosion_and_entrainment1" type="radio" value="Yes" name="erosion_and_entrainment"
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="erosion_and_entrainment1"
                        class="ms-2 text-sm text-gray-900 dark:text-gray-300">Yes</label>
                </div>
                <div class="mr-4">
                    <input id="erosion_and_entrainment2" type="radio" value="No" name="erosion_and_entrainment" checked
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="erosion_and_entrainment2" class="ms-2 text-sm text-gray-900 dark:text-gray-300">No
                    </label>
                </div>
                <p class="text-sm my-2">
                    If the required data are not available in SIFT report, then No should be assumed
...
<div class="grid sm:grid-cols-2 gap-4">
    ...
    <div>
        <div class="mb-3">
            ...
            <div class="mb-2">
                <div class="mr-4">
                    <input id="spread_of_debris1" type="radio" value="Yes" name="spread_of_debris"
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="spread_of_debris1" class="ms-2 text-sm text-gray-900 dark:text-gray-300">Yes</label>
                </div>
                <div class="mr-4">
                    <input id="spread_of_debris2" type="radio" value="No" name="spread_of_debris" checked
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="spread_of_debris2" class="ms-2 text-sm text-gray-900 dark:text-gray-300">No
                    </label>
                </div>
                <p class="text-sm my-2">
                    If the required data are not available in SIFT report, then No should be assumed
...
<div class="grid sm:grid-cols-2 gap-4">
    ...
    <div>
        <div class="mb-3">
            <legend class="font-semibold mb-2">Obtain terrain classification for the area(s) between the slope and toe
                facilities based on
                relevant GASP Reports
            </legend>
            <div class="mb-2">
                <div class="mr-4">
                    <input id="unstable_terrain1" type="radio"
                        value='Zones of general instability associated with predominantly colluvial terrain or in-situ terrain'
                        name="unstable_terrain"
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="unstable_terrain1" class="ms-2 text-sm text-gray-900 dark:text-gray-300">Zones of
                        general instability associated with predominantly colluvial terrain or
                        in-situ terrain, </label>
                </div>
                <div class="mr-4">
                    <input id="unstable_terrain2" type="radio" value="disturbed terrain" name="unstable_terrain" checked
                        class=" w-4 h-4 text-lime-600 bg-gray-100 border-gray-300 focus:ring-lime-500 dark:focus:ring-lime-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="unstable_terrain2" class="ms-2 text-sm text-gray-900 dark:text-gray-300">Instability on
                        disturbed terrain
                    </label>
                </div>
                <p class="text-sm my-2">
                    If terrain between the slope and toe facilities meets both of the above criteria, the terrain
