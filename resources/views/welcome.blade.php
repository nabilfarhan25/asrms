...
<body>
            ...
            <div class="flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                    <ul
                        ...
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-lime-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Services</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-lime-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Pricing</a>
                        </li>
                        <li>
                            <a href="#"
                                class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-lime-600 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div style="background-image: url('/components/bg3.webp')"
                        ...
                        <div class="text-center flex items-center animate-fade-up">
                            <figure class="max-w-screen-md mx-auto text-center">
                                ...
                                <blockquote>
                                    <p class=" sm:text-2xl italic font-mediumtext-white">"Engineering is the
    ...
    <div class="flex flex-wrap justify-center p-5">
        ...
        <a class="m-1" href="https://map-srms.gwadestek.com/" target="_blank">
            <div
                class="max-w-60 border-2 border-gray-300 px-5 py-10 rounded-3xl group transition ease-in-out duration-150 hover:shadow hover:text-lime-600 hover:border-lime-600 h-full">
                <div class="flex justify-center mb-3">
